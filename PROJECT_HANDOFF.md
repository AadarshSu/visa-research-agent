...
(`api/ofself.py`, step 3) is built, tested offline, and run against a live sandbox user — nothing calls it yet. Paradigm stores user data and does not host apps, as far as
